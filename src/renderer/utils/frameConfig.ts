...
export const FRAME_CONFIGS: FrameConfig[] = [
  ...
  },
  {
    ...
    orientation: 'portrait' as const,
    slots: [
      { id: 'blvd_1x3_slot_1', x: 35, y: 54, width: 1130, height: 1083, radius: 0 },
      { id: 'blvd_1x3_slot_2', x: 35, y: 1163, width: 1130, height: 1083, radius: 0 },
      { id: 'blvd_1x3_slot_3', x: 37, y: 2275, width: 1130, height: 1083, radius: 0 },
    ],
    previewSlots: [
      { id: 'blvd_1x3_slot_1', x: 35, y: 54, width: 1130, height: 1083, radius: 15 },
      { id: 'blvd_1x3_slot_2', x: 35, y: 1163, width: 1130, height: 1083, radius: 15 },
      { id: 'blvd_1x3_slot_3', x: 37, y: 2275, width: 1130, height: 1083, radius: 15 },
    ],
  },
  {
    id: 'blvd_2x3',
  ...
  },
  {
    ...
    slots: [
      { id: 'burningcity_3x2_slot_1', x: 50, y: 70, width: 1154, height: 1118, radius: 0 },
      { id: 'burningcity_3x2_slot_2', x: 1220, y: 78, width: 1154, height: 1118, radius: 0 },
      { id: 'burningcity_3x2_slot_3', x: 2390, y: 74, width: 1154, height: 1118, radius: 0 },
      { id: 'burningcity_3x2_slot_4', x: 50, y: 1200, width: 1154, height: 1118, radius: 0 },
      { id: 'burningcity_3x2_slot_5', x: 1222, y: 1202, width: 1154, height: 1118, radius: 0 },
      { id: 'burningcity_3x2_slot_6', x: 2384, y: 1202, width: 1154, height: 1118, radius: 0 },
    ],
  },
  {
    id: 'modern_4x6',
